  ...
  var body: some View {
    VStack(spacing: 0) {
        ...
        ZStack(alignment: .center) {
          VStack(alignment: .center, spacing: 0) {
            VStack {
              ...
              Text("Photo: Ziady Mubaraq (It's Me)")
            ...
            Text("At this step, you need to select a photo that has sufficient lighting and good quality.")
              .foregroundColor(Color.secondary)
              .frame(alignment: .leading)
      ...
      if #available(iOS 16.0, *) {
        NavigationLink(
          destination: FacetingScene(path: $path),
          isActive: $nextPage) {
